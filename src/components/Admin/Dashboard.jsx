...
import AgencyCommission from './AgencyCommission';
import DynamicTables from './DynamicTables';
import CategoryPresets from './CategoryPresets'; // Import the new component
import Logo from '../../assets/Logo.png';
        ...
        <Row className="mb-4 dashboard-stats g-3">
          ...
          <Col lg={9} md={6} className="mb-3">
            <Card className="border-0 shadow-sm h-100 dashboard-card">
              <Card.Body className="p-3">
                <p className="mb-0 small">
                  Welcome to the TSBI Studios admin dashboard. Manage services, create category presets, 
                  view proposals, set commission rates, and create custom data tables.
                </p>
              </Card.Body>
            </Card>
          </Col>
            ...
            <Tab.Container activeKey={activeTab} onSelect={setActiveTab}>
              <Nav variant="tabs" className="nav-tabs-custom">
                ...
                <Nav.Item>
                  <Nav.Link 
                    eventKey="categories" 
                    className={`px-3 py-2 d-flex align-items-center ${activeTab === 'categories' ? 'active' : ''}`}
                  >
                    <FontAwesomeIcon icon={faLayerGroup} className="me-2" />
                    <span>Category Presets</span>
                    <Badge bg="primary" pill className="ms-2" style={{ fontSize: '0.65rem' }}>New</Badge>
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link 
                ...
                {/* <Nav.Item>
                 ...
                 <Nav.Item>
                  <Nav.Link 
                    eventKey="tables1" 
                    className={`px-3 py-2 d-flex align-items-center ${activeTab === 'tables1' ? 'active' : ''}`}
                  >
                    <FontAwesomeIcon icon={faDatabase} className="me-2" />
