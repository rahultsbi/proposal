...
// // //       setCurrentCommission(response.data.commissionRate);
// // //       setCommission(response.data.commissionRate.toString());
// // //     } catch (error) {
...
// // //       // Send the updated commission rate to the server
// // //       await axios.post('/api/settings/commission', {
...
// //       // Safely extract commission rate with fallback
// //       const commissionRate = response?.data?.commissionRate ?? 0;
...
// //       // Send the updated commission rate to the server
// //       const response = await axios.post('/api/settings/commission', {
// //         commissionRate: commissionValue
// //       });
...
// //     } catch (error) {
// //       console.error('Error updating commission rate:', error);
// //       setError(`Failed to update commission rate: ${error.response?.data?.error || error.message}`);
// //     } finally {
// //       setIsSaving(false);
// //     }
// //   };
...
//       // Make the API request - adjust the URL if needed
//       const response = await axios.get('/api/settings/commission');
//       console.log('Commission rate response:', response);
