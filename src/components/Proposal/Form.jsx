...
// //           // Calculate based on selected items with individual rates
// //           serviceData.selectedItems.forEach(item => {
// //             // Use price_rate_rent first, then fallback to rate
// //             const rate = parseFloat(item.price_rate_rent || item.rate) || 0;
// //             const itemTotal = rate * formData.days;
// //             console.log(`💵 Item rate: ${rate}, days: ${formData.days}, item total: ${itemTotal}`);
// //             calculatedTotal += itemTotal;
// //           });
...
// //           {/* Show selected items with enhanced display */}
// //           {serviceFormData?.selectedItems?.length > 0 && !serviceFormData.useDefault && (
// //             <div className="mt-2">
// //               {serviceFormData.selectedItems.map((item, idx) => (
// //                 <div key={idx} className="card border-success mb-2 p-2">
// //                   <div className="d-flex justify-content-between align-items-start">
// //                     <div className="flex-grow-1">
...
// //                             {item.experience_years || item.experience} years experience
// //                           </div>
// //                         )}
...
// //                             Studio: {item.studio_size}
// //                           </div>
// //                         )}
                        
// //                         {item.generator_specification && (
// //                           <div className="mb-1">
...
// //                         {(item.contact_number || item.contact) && (
// //                           <div className="mb-1">
...
// //                         {(item.remarks_rating || item.rating) && (
// //                           <div className="mb-1">
// //                             <FontAwesomeIcon icon={faStar} className="me-1" />
// //                             {item.remarks_rating || (item.rating && `${item.rating} stars`)}
// //                           </div>
// //                         )}
// //                       </div>
// //                     </div>
...
// //                         ₹{parseFloat(item.price_rate_rent || item.rate || 0).toLocaleString()}/day
// //                       </Badge>
// //                     </div>
// //                   </div>
// //                 </div>
...
// //               ₹{(() => {
// //                 if (serviceFormData.selectedItems?.length > 0 && !serviceFormData.useDefault) {
// //                   return serviceFormData.selectedItems.reduce((sum, item) => sum + (parseFloat(item.price_rate_rent || item.rate) || 0), 0) * formData.days;
// //                 } else {
// //                   return service.rate_per_day * serviceFormData.quantity * formData.days;
// //                 }
// //               })().toLocaleString()}
...
// //                    <>
// //                      <hr className="my-4" />
// //                      <div className="summary-section p-4 bg-light rounded border">
// //                        <h6 className="mb-3">
...
// //                            return (
// //                              <Col md={6} key={serviceId} className="mb-3">
// //                                <Card className="h-100 border-success">
// //                                  <Card.Body className="p-3">
// //                                    <div className="d-flex justify-content-between align-items-start mb-2">
// //                                      <div className="flex-grow-1">
// //                                        <strong className="text-success">{service.service_name}</strong>
// //                                        <div className="small text-muted">
// //                                          {formData.days} day{formData.days !== 1 ? 's' : ''} × Qty: {serviceFormData.quantity}
// //                                        </div>
// //                                      </div>
// //                                      <Badge bg="success" className="fs-6">
// //                                        ₹{(() => {
...
// //                                    {serviceFormData.selectedItems && serviceFormData.selectedItems.length > 0 && !serviceFormData.useDefault ? (
// //                                      <div className="mt-2">
// //                                        <div className="small text-success fw-bold mb-1">Custom Selection:</div>
// //                                        {serviceFormData.selectedItems.map((item, index) => (
// //                                          <div key={index} className="small mb-1 p-2 bg-white rounded border">
// //                                            <div className="d-flex justify-content-between align-items-center">
// //                                              <div>
// //                                                <FontAwesomeIcon icon={faCheck} className="me-1 text-success" />
// //                                                <strong>{item.name}</strong>
// //                                                {item.is_default && (
// //                                                  <Badge bg="primary" size="sm" className="ms-1">Default</Badge>
// //                                                )}
// //                                              </div>
...
// //                                        Using standard rate: ₹{service.rate_per_day.toLocaleString()}/day
// //                                      </div>
// //                                    )}
// //                                  </Card.Body>
// //                                </Card>
...
// //                        <div className="d-flex justify-content-between align-items-center">
// //                          <div>
// //                            <h5 className="mb-0">Total Project Cost:</h5>
// //                            <small className="text-muted">For {formData.days} day{formData.days !== 1 ? 's' : ''} of production</small>
// //                          </div>
// //                          <h3 className="mb-0 text-success fw-bold">₹{total.toLocaleString()}</h3>
// //                        </div>
// //                      </div>
// //                    </>
// //                  )}
...
// //      <Modal show={showServiceModal} onHide={() => setShowServiceModal(false)} size="xl">
// //        <Modal.Header closeButton>
// //          <Modal.Title>
// //            <FontAwesomeIcon icon={faUsers} className="me-2" />
// //            Select {selectedService?.service_name}
...
// //                      {selectedServiceItems.map(item => {
// //                        const isSelected = formData.services[selectedService?.id]?.selectedItems?.some(selected => selected.id === item.id);
// //                        const rate = parseFloat(item.price_rate_rent || item.rate) || selectedService?.rate_per_day || 0;
...
// //                            </td>
// //                            <td>
// //                              <Badge bg="info" className="fs-6">₹{rate.toLocaleString()}</Badge>
// //                            </td>
// //                            <td>
// //                              <div className="small">
// //                                {item.studio_size && (
// //                                  <div className="mb-1">
// //                                    <FontAwesomeIcon icon={faTools} className="me-1" />
// //                                    <strong>Studio:</strong> {item.studio_size}
// //                                  </div>
// //                                )}
...
// //                                  <div className="mb-1">
// //                                    <FontAwesomeIcon icon={faStopwatch} className="me-1" />
// //                                    <strong>Hours:</strong> {item.shift_time}
// //                                  </div>
// //                                )}
...
// //                                  <div className="mb-1">
// //                                    <FontAwesomeIcon icon={faBolt} className="me-1" />
// //                                    <strong>Generator:</strong> {item.generator_specification}
// //                                  </div>
// //                                )}
...
// //                                  <div className="mb-1">
// //                                    <FontAwesomeIcon icon={faPhone} className="me-1" />
// //                                    <strong>Contact:</strong> {item.contact_number || item.contact}
// //                                  </div>
// //                                )}
...
// //                                    <strong>Email:</strong> {item.mail_id}
// //                                  </div>
// //                                )}
...
// //                                  <div className="mb-1">
// //                                    <FontAwesomeIcon icon={faStar} className="me-1" />
// //                                    <strong>Rating:</strong> {item.remarks_rating || (item.rating && `${item.rating} stars`)}
// //                                  </div>
// //                                )}
                               
// //                                {(item.profile_worklinks || item.profile_link) && (
// //                                  <div>
// //                                    <a 
// //                                      href={item.profile_worklinks || item.profile_link} 
// //                                      target="_blank" 
// //                                      rel="noopener noreferrer"
...
//     } catch (error) {
//       console.error(`❌ Error loading service data for ${serviceId}:`, error);
//       // Set empty array to indicate we checked but found no data
//       setServiceData(prev => ({
//         ...prev,
//         [serviceId]: []
//       }));
...
//   // Pre-load service data for all services when they're loaded
//   useEffect(() => {
//     if (services.length > 0) {
//       services.forEach(service => {
//         if (!serviceData.hasOwnProperty(service.id)) {
//           loadServiceSpecificData(service.id);
//         }
//       });
//     }
//   }, [services]);
...
//   // FIXED: Optimized handleItemSelection with useCallback to prevent re-renders
...
//         if (currentService.selectedItems.some(selected => selected.id === item.id)) {
...
//     // Check if this service has specific data available
//     const hasServiceData = serviceData[service.id] && serviceData[service.id].length > 0;
//     const dataCount = serviceData[service.id]?.length || 0;
//     const isDataLoaded = serviceData.hasOwnProperty(service.id);
...
//           <div className="d-flex align-items-center">
//             <strong>{service.service_name}</strong>
//             {/* Show availability badge immediately when data is loaded */}
//             {isDataLoaded && (
//               hasServiceData ? (
...
//             {!isDataLoaded && (
//               <Badge bg="light" className="ms-2 small">
...
//         <td>
//           <div>
//             {/* Always show default rate first */}
//             <Badge bg="secondary" className="mb-2">₹{service.rate_per_day?.toLocaleString()}/day</Badge>
//             <div className="small text-muted mb-2">
//               {serviceFormData?.useDefault !== false ? 'Using default rate' : 'Custom selection active'}
//             </div>
            
//             {/* Only show button if data is available */}
//             {hasServiceData && (
//               <Button
//                 variant={serviceFormData?.useDefault !== false ? "outline-primary" : "outline-success"}
//                 size="sm"
//                 onClick={() => openServiceModal(service)}
//                 className="d-block"
//               >
//                 <FontAwesomeIcon icon={faUsers} className="me-1" />
//                 {serviceFormData?.useDefault !== false 
//                   ? `Choose from ${dataCount} options` 
//                   : `Change (${serviceFormData.selectedItems?.length || 0} selected)`
//                 }
//               </Button>
//             )}
//           </div>
...
//               size="sm"
//               onClick={() => {
//                 // If service has data and no selection made, auto-open modal
//                 if (hasServiceData && (!serviceFormData || serviceFormData.quantity === 0)) {
//                   handleServiceQuantityChange(service.id, 1);
//                   setTimeout(() => openServiceModal(service), 100); // Small delay for state update
//                 } else {
//                   handleServiceQuantityChange(service.id, 1);
//                 }
//               }}
...
//     );
//   };
//   // FIXED: Optimized modal with memoization to prevent re-renders
//  const ServiceSelectionModal = useMemo(() => {
//     if (!selectedService) return null;
    
//     const currentServiceData = formData.services[selectedService.id] || { quantity: 1, selectedItems: [], useDefault: true };
//     const selectedItems = currentServiceData.selectedItems || [];
//     const hasSelectedItems = selectedItems.length > 0;
    
//     // Calculate total cost
//     const totalSelectedCost = selectedItems.reduce((sum, item) => 
//       sum + (parseFloat(item.price_rate_rent || item.rate) || 0), 0
//     );
...
//               <div className="d-flex justify-content-between align-items-center mb-3">
//                 <div>
//                   <h6 className="mb-1">Available {selectedService.service_name}s</h6>
//                   <p className="text-muted mb-0 small">
//                     {selectedServiceItems.length} options available • Default rate: ₹{selectedService.rate_per_day?.toLocaleString()}/day
//                   </p>
//                 </div>
//                 <Badge bg="secondary">
...
//               {/* FIXED: Conditional alerts with stable rendering */}
//               {!hasSelectedItems ? (
...
//                       Currently using default rate of ₹{selectedService.rate_per_day?.toLocaleString()}/day
//                     </div>
//                     <Badge bg="info">Default Mode</Badge>
//                   </div>
//                   <div className="small mt-2">
//                     Select specific {selectedService.service_name.toLowerCase()}s below to use custom rates, or keep using the default rate.
//                   </div>
//                 </Alert>
//               ) : (
...
//                     <div>
//                       <FontAwesomeIcon icon={faUsers} className="me-2" />
//                       Custom selection active - {selectedItems.length} {selectedService.service_name.toLowerCase()}{selectedItems.length !== 1 ? 's' : ''} selected
//                     </div>
//                     <div className="d-flex gap-2">
//                       <Badge bg="success">
//                         ₹{totalSelectedCost.toLocaleString()}/day total
//                       </Badge>
//                       <Button
//                         variant="outline-danger"
//                         size="sm"
...
//                               ...prev.services,
//                               [selectedService.id]: {
//                                 ...prev.services[selectedService.id],
//                                 selectedItems: [],
//                                 useDefault: true
//                               }
//                             }
...
//                       <th width="15%">Rate/Day</th>
//                       <th width="20%">Contact & Location</th>
//                       <th width="30%">Additional Details</th>
//                     </tr>
//                   </thead>
//                   <tbody>
//                     {selectedServiceItems.map(item => {
...
//                               ₹{rate.toLocaleString()}
//                             </Badge>
//                             {rate !== selectedService.rate_per_day && (
//                               <div className="small text-muted mt-1">
//                                 {rate > selectedService.rate_per_day ? 'Premium' : 'Discounted'}
//                               </div>
//                             )}
//                           </td>
//                           <td>
...
//                              {item.shift_time && (
//                                <div className="mb-1">
//                                  <FontAwesomeIcon icon={faStopwatch} className="me-1 text-muted" />
//                                  <strong>Hours:</strong> {item.shift_time}
//                                </div>
//                              )}
...
//                              {item.generator_specification && (
//                                <div className="mb-1">
//                                  <FontAwesomeIcon icon={faBolt} className="me-1 text-muted" />
//                                  <strong>Power:</strong> {item.generator_specification}
//                                </div>
//                              )}
...
//                                  {item.remarks_rating || (item.rating && `${item.rating}/5 stars`)}
//                                </div>
//                              )}
...
//              <FontAwesomeIcon icon={faInfoCircle} size="3x" className="text-muted mb-3" />
//              <h6>No custom options available</h6>
//              <p className="text-muted">
//                This service uses a standard rate of ₹{selectedService.rate_per_day?.toLocaleString()}/day. 
//                Individual selections are not available for this service.
//              </p>
//            </div>
//          )}
//        </Modal.Body>
...
//              <FontAwesomeIcon icon={faCheck} className="me-2" />
//              {hasSelectedItems 
//                ? `Confirm Selection (${selectedItems.length} selected)`
//                : 'Use Default Rate'
//              }
//            </Button>
//          )}
...
//      </Modal>
//    );
//  }, [selectedService, formData.services, selectedServiceItems, showServiceModal, loadingServiceData, handleItemSelection]);
...
//      {/* FIXED: Optimized Modal with memoization */}
...
function ProposalForm({ onSubmit, onAdminClick, onHomeClick, onDashboardClick }) {
  ...
  const AdjustmentControls = ({ onAddAdjustment }) => {
    ...
    const presetAdjustments = [
      { type: 'percentage', operation: 'subtract', value: 5, reason: 'Early Bird Discount' },
      { type: 'percentage', operation: 'subtract', value: 10, reason: 'Volume Discount' },
      { type: 'percentage', operation: 'subtract', value: 15, reason: 'Loyal Client Discount' },
      { type: 'percentage', operation: 'add', value: 10, reason: 'Rush Order Surcharge' },
      { type: 'percentage', operation: 'add', value: 15, reason: 'Weekend/Holiday Premium' },
      { type: 'percentage', operation: 'add', value: 5, reason: 'Additional Revisions' }
    ];

    const handlePresetClick = (preset) => {
      onAddAdjustment(preset);
    };

    const handleCustomSubmit = () => {
      if (adjustmentData.value && adjustmentData.reason) {
        onAddAdjustment({
          ...adjustmentData,
          value: parseFloat(adjustmentData.value)
        });
        setAdjustmentData({ type: 'percentage', operation: 'subtract', value: '', reason: '' });
    ...
    return (
      <div className="adjustment-controls">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          >
            <FontAwesomeIcon icon={showAdjustment ? faMinus : faPlus} className="me-1" />
            {showAdjustment ? 'Cancel' : 'Add Adjustment'}
          </Button>
        </div>

        {/* Quick Preset Buttons */}
        <div className="preset-adjustments mb-3">
          <div className="small text-muted mb-2">Quick Actions:</div>
          <div className="d-flex flex-wrap gap-2">
            {presetAdjustments.map((preset, index) => (
              <Button
                key={index}
                variant={preset.operation === 'add' ? 'outline-success' : 'outline-warning'}
                size="sm"
                onClick={() => handlePresetClick(preset)}
              >
                {preset.operation === 'add' ? '+' : '-'}{preset.value}% {preset.reason}
              </Button>
            ))}
          </div>
        </div>
                ...
                <Col md={3}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Select
                      ...
                      onChange={(e) => setAdjustmentData(prev => ({ ...prev, operation: e.target.value }))}
                    >
                      <option value="subtract">Discount (-)</option>
                      <option value="add">Surcharge (+)</option>
                    </Form.Select>
                  </Form.Group>
                </Col>
                <Col md={2}>
                  <Form.Group className="mb-3">
                    ...
                    <InputGroup size="sm">
                      <Form.Control
                        ...
                        onChange={(e) => setAdjustmentData(prev => ({ ...prev, value: e.target.value }))}
                        placeholder={adjustmentData.type === 'percentage' ? '5' : '1000'}
                      />
                      <InputGroup.Text>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <div className="d-flex gap-1">
                      <Form.Control
                        ...
                        placeholder="e.g., Volume discount, Rush order"
                      />
                      <Button
                        variant="success"
                        size="sm"
                        onClick={handleCustomSubmit}
                        disabled={!adjustmentData.value || !adjustmentData.reason}
                      >
  ...
  const calculateTotal = () => {
    ...
    console.log('💰 Base total calculated:', calculatedTotal);
    ...
    adjustments.forEach(adjustment => {
      if (adjustment.type === 'percentage') {
        const adjustmentAmount = (calculatedTotal * adjustment.value) / 100;
        finalTotal += adjustment.operation === 'add' ? adjustmentAmount : -adjustmentAmount;
      } else if (adjustment.type === 'fixed') {
        finalTotal += adjustment.operation === 'add' ? adjustment.value : -adjustment.value;
      }
    });
    
    console.log('💰 Final total with adjustments:', finalTotal);
    setTotal(Math.max(0, finalTotal)); // Ensure total doesn't go negative
  };

  // Add new adjustment
  const addAdjustment = (adjustment) => {
    setAdjustments(prev => [...prev, { ...adjustment, id: Date.now() }]);
  };
...
const handleServiceQuantityChange = (serviceId, change) => {
  ...
  setFormData(prev => {
    const currentService = prev.services[serviceId] || { quantity: 0, selectedItems: [], useDefault: true };
    const availableItems = serviceData[serviceId] || [];
    const hasAvailableItems = availableItems.length > 0;
    
    // Calculate new quantity
    let newQuantity = Math.max(0, currentService.quantity + change);
    
    console.log(`🔢 Current quantity: ${currentService.quantity}, new quantity: ${newQuantity}`);
    console.log(`🔢 Available items: ${availableItems.length}, useDefault: ${currentService.useDefault}`);
    ...
    if (newQuantity === 0) {
      ...
      // Smart quantity logic based on mode
      if (!currentService.useDefault && hasAvailableItems) {
        // Custom selection mode - quantity should match selected items
        if (change > 0) {
          // Increasing quantity - limit to available items
          const maxPossibleQuantity = Math.min(availableItems.length, currentService.selectedItems.length + change);
          newQuantity = Math.min(newQuantity, maxPossibleQuantity);
          
          // If we have selected items, we can't exceed the number of selected items
          if (currentService.selectedItems.length > 0) {
            newQuantity = Math.min(newQuantity, currentService.selectedItems.length);
          }
        } else {
          // Decreasing quantity - remove items from selection
          const itemsToRemove = Math.abs(change);
          const updatedSelectedItems = [...currentService.selectedItems];
          
          // Remove items from the end of the selection
          for (let i = 0; i < itemsToRemove && updatedSelectedItems.length > 0; i++) {
            updatedSelectedItems.pop();
          }
          
          // Update quantity to match remaining selected items
          newQuantity = updatedSelectedItems.length;
          
          // If no items left, switch to default mode
          const shouldUseDefault = updatedSelectedItems.length === 0;
          
          newServices[serviceId] = {
            ...currentService,
            quantity: Math.max(newQuantity, shouldUseDefault ? 1 : 0),
            selectedItems: updatedSelectedItems,
            useDefault: shouldUseDefault
          };
          
          console.log(`📊 Updated service ${serviceId}:`, newServices[serviceId]);
          return {
            ...prev,
            services: newServices
          };
        ...
        // Default mode - normal quantity logic (no restrictions)
        // Just ensure we don't go below 1 in default mode
        newQuantity = Math.max(1, newQuantity);
      }
      
      console.log(`📊 Final quantity for service ${serviceId}: ${newQuantity}`);
...
const handleItemSelection = useCallback((item, isSelected) => {
  ...
  setFormData(prev => {
    ...
    const newQuantity = Math.max(newSelectedItems.length, newSelectedItems.length > 0 ? newSelectedItems.length : 1);
    const shouldUseDefault = newSelectedItems.length === 0;
    
    console.log(`🎯 Selected items: ${newSelectedItems.length}, new quantity: ${newQuantity}, useDefault: ${shouldUseDefault}`);
    ...
    return {
      ...
      services: {
        ...
        [serviceId]: {
          ...
          selectedItems: newSelectedItems,
          useDefault: shouldUseDefault,
          quantity: shouldUseDefault ? Math.max(currentService.quantity, 1) : newQuantity
        }
      }
    };
  });
}, [selectedService?.id, serviceData]);
...
//             <div className="mt-2">
//               {serviceFormData.selectedItems.map((item, idx) => (
//                 <div key={idx} style={{border:'1px solid red'}} className="card border-success mb-2 p-2">
//                   <div className="d-flex justify-content-between align-items-start">
//                     <div className="flex-grow-1">
//                       <div className="d-flex align-items-center mb-1">
//                         <FontAwesomeIcon icon={faCheck} className="me-2 text-success" />
...
const renderServiceItem = (service, index) => {
  ...
  const getMaxQuantity = () => {
    if (!serviceFormData || serviceFormData.useDefault !== false) {
      return 999; // No limit for default mode
    }
    
    if (hasServiceData && serviceFormData.selectedItems.length > 0) {
      return serviceFormData.selectedItems.length; // Limited to selected items
    }
    
    return hasServiceData ? dataCount : 999; // Limited to available items or no limit
  };
  
  const maxQuantity = getMaxQuantity();
  const canIncrease = !isSelected || (serviceFormData && serviceFormData.quantity < maxQuantity);
  const canDecrease = isSelected && serviceFormData && serviceFormData.quantity > 0;
          ...
          <div className="mt-1">
            {serviceFormData.useDefault !== false ? (
              ...
              <Badge bg="info" className="small">
                <FontAwesomeIcon icon={faUsers} className="me-1" />
                Custom Selection Mode ({serviceFormData.selectedItems?.length || 0}/{dataCount})
              </Badge>
            )}
          </div>
        )}
      ...
      <td>
        <div className="d-flex align-items-center gap-2">
          <Button 
            ...
            title={!canDecrease ? "Cannot decrease below 0" : "Decrease quantity"}
          >
            <FontAwesomeIcon icon={faMinus} />
          </Button>
          <span className="px-3 py-1 bg-light rounded text-center fw-bold position-relative" style={{ minWidth: '45px' }}>
            {serviceFormData?.quantity || 0}
            {/* Show limit indicator in custom mode */}
            {serviceFormData && serviceFormData.useDefault === false && hasServiceData && (
              <small className="text-muted d-block" style={{ fontSize: '0.7rem', lineHeight: '1' }}>
                max {serviceFormData.selectedItems?.length || dataCount}
              </small>
            )}
          </span>
          <Button 
            ...
            size="sm"
            onClick={() => {
              // Enhanced logic for increase button
              if (hasServiceData && (!serviceFormData || serviceFormData.quantity === 0)) {
                handleServiceQuantityChange(service.id, 1);
                setTimeout(() => openServiceModal(service), 100); // Small delay for state update
              } else {
            ...
            title={
              !canIncrease 
                ? (serviceFormData?.useDefault === false 
                    ? `Cannot exceed ${maxQuantity} (selected items limit)` 
                    : "Cannot increase")
                : "Increase quantity"
            }
          >
        ...
        {serviceFormData && serviceFormData.useDefault === false && hasServiceData && (
          <div className="small text-info mt-2">
            <FontAwesomeIcon icon={faInfoCircle} className="me-1" />
            {serviceFormData.selectedItems?.length === 0 
              ? "Select items to set quantity"
              : `Quantity matches selected items (${serviceFormData.selectedItems.length})`
            }
          </div>
        )}
      </td>
 ...
 return (
   <div className="proposal-form-component">
                     ...
                     <div className="summary-section p-4 bg-light rounded border">
                       ...
                       <div className="cost-breakdown">
                         <div className="d-flex justify-content-between align-items-center mb-2">
                           ...
                           <span className="fw-bold">₹{baseTotal.toLocaleString()}</span>
                         </div>
                         
                         {/* Adjustments Section */}
                         {adjustments.length > 0 && (
                           <div className="adjustments-section mb-3">
                             {adjustments.map(adjustment => (
                               <div key={adjustment.id} className="d-flex justify-content-between align-items-center mb-1">
                                 <div className="d-flex align-items-center">
                                   <span className={`text-${adjustment.operation === 'add' ? 'success' : 'danger'}`}>
                                     {adjustment.operation === 'add' ? '+' : '-'}
                                     {adjustment.type === 'percentage' 
                                       ? `${adjustment.value}%` 
                                       : `₹${adjustment.value.toLocaleString()}`
                                     } ({adjustment.reason})
                                   </span>
                                   <Button
                                     variant="outline-danger"
                                 ...
                                 <span className={`text-${adjustment.operation === 'add' ? 'success' : 'danger'}`}>
                                   {adjustment.operation === 'add' ? '+' : '-'}₹{
                                     adjustment.type === 'percentage' 
                                       ? ((baseTotal * adjustment.value) / 100).toLocaleString()
                                       : adjustment.value.toLocaleString()
                                   }
                                 </span>
                               </div>
                         ...
                         <AdjustmentControls onAddAdjustment={addAdjustment} />
     ...
     <style jsx>{`
       ...
       .adjustment-controls .preset-adjustments {
         background-color: #f8f9fa;
         border-radius: 6px;
         padding: 0.75rem;
       }
       
       .preset-adjustments .btn {
         transition: all 0.2s ease;
       }
       
       .preset-adjustments .btn:hover {
